$(document).ready(function() {
    ...
    $('#busCalendar').fullCalendar({
        eventSources : [{url: '../getFullBusSchedule.php'}],
      ...
      var BstrapModal = function (title, body, buttons) {
          ...
          "<select id='selectList'></select>", buttons = buttons || [{ Value: "SUBMIT",
          Css: "btn-primary", Callback: function (event) { BstrapModal.Submit(); } }];
